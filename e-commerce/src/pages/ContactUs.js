...
export default function ContactUs() {
  return (
    <div className="mx-52 max-sm:mx-5 mt-5">
      <div className="flex max-sm:flex-col justify-center items-center">
        ...
        <div className="relative inline-block w-[50%] max-sm:w-full">
      ...
      <div className="flex flex-col justify-center items-center gap-3 mt-20">
        ...
        <h1 className="text-4xl font-bold w-[50%] max-sm:w-full">
          We help small businesses with big ideas
        </h1>
        <div className="flex max-sm:flex-col justify-center items-center my-16">
          <div className="flex flex-col justify-center items-center gap-6 hover:bg-sky-950 hover:text-white  px-10 py-16 max-sm:py-8">
      ...
      <div className="flex flex-col justify-center items-center gap-5">
        ...
        <h4 className="font-bold text-xs max-sm:text-xs">
